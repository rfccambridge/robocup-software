...
parser.add_argument(
    ...
    "--simulate",
    action="store_true",
    help="run the codebase using sim rather than real vision data/robots",
)
parser.add_argument(
    "-ss",
    "--simulator_setup",
...
parser.add_argument(
    "-nre", "--no_refbox",
    action="store_true", help="Ignores commands from the refbox."
)
parser.add_argument(
    "-cbt",
    "--control_both_teams",
    action="store_true",
    help="Indicates that we are playing against ourselves and so we should"
         " play as both teams.",
)
parser.add_argument(
    "-htc",
